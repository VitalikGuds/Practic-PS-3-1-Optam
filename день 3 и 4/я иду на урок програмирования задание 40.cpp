//Даны первый член n разность арифметической прогресси . Написать рукурсивную функцию:а)нахождения n-го члена прогресии;б)нахождения суммы n первых членов прогресии;
#include <iostream>
